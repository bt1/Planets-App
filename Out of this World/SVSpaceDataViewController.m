...
@interface SVSpaceDataViewController ()

@end

@implementation SVSpaceDataViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        ...
        case 2:
            cell.textLabel.text = @"Graviataional Force:";
        ...
        case 7:
            cell.textLabel.text = @"Intersting fact:";
